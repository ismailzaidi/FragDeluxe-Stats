...
public class CompareRecyclerAdapter extends RecyclerView.Adapter<CompareRecyclerAdapter.CompareHolder> {
    private List<Player> compareList;
    private String type;

    public CompareRecyclerAdapter(List<Player> compareList, String type) {
    ...
    public void onBindViewHolder(CompareHolder holder, int position) {
        ...
        compareView.setWeaponLayout(player);
    }
